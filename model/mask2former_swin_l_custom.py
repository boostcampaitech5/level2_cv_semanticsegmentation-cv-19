...
class Mask2Former_Swin_L(BaseModel):
    def __init__(self, num_classes=29):
        super(Mask2Former_Swin_L, self).__init__()
        self.model = Mask2FormerForUniversalSegmentation.from_pretrained(
            "facebook/mask2former-swin-large-ade-semantic", num_labels=num_classes, ignore_mismatched_sizes=True
        )
